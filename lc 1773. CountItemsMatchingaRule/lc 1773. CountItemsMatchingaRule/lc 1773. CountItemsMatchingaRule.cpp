// lc1773. CountItemsMatchingaRule.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
/*
...
int countMatches(vector<vector<string>>& vec, string ruleKey, string ruleValue)
{
    int x, sum = 0;
